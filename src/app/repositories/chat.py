...
class ChatRepository:
    @staticmethod
    async def create(task_id: int, sender_id: int, content: str, session: AsyncSession, file_url: str | None = None, file_name: str | None = None, file_type: str | None = None, is_secure_file: bool = False) -> ChatMessage:
        message = ChatMessage(
            task_id=task_id, 
            sender_id=sender_id, 
            content=content,
